...
export const ccpoints = [
  ...
  },
  {
    ...
    date: "March 05 2022",
    source: "Found on Internet",
    imgurl: ['https://mkip.notion.site/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Fa3d7fa8b-d3f4-4c72-bfcf-05d2640eff3c%2F1653737522-675.jpg?id=f9fee0f7-593c-47cc-8468-9187a6ea9b79&table=block&spaceId=16081de0-bdcc-4711-9318-4d7f3bb8bf24&width=600&userId=&cache=v2'],
    link: "https://www.arxaiologikoktimatologio.gov.gr/el/monuments_info?id=164525&type=Monument",
    description:
  ...
  //Donetsk
  {
    ...
    colorfill: "#60696B",
    title:
      "Residential building (building of the late XIXth - early XXth centuries)",
    objecttag: ["Ancient buildings"],
    other_tags: [""],
    date: "April 1 2022",
    source: "Found on Internet",
  ...
  ///New Updated with photos and everything Kiev
  {
    ...
    y: 50.019972,
    colorfill: "#60696B",
    title: "Skovorodynivskyy University (modern building)",
    subtitle: "Kharkiv city, Valentynivska street, 2",
    objecttag: ["Libraries"],
    other_tags: ["Museums", "Monuments"],
    date: "July 6, 2022",
    source: "Found on Internet",
    imgurl: [
      "https://mkip.notion.site/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F379f89f4-3a4d-484d-9c5e-7f839388bfb4%2F292308791_5094930350562072_994452577753670867_n.jpg?table=block&id=01612d76-aa4e-4251-b1c0-2ca5ed5a2888&spaceId=16081de0-bdcc-4711-9318-4d7f3bb8bf24&width=600&userId=&cache=v2",
    ],
...
export const ccAthnes = [
  ...
  },
  {
    ...
    imgurl: [],
    description:
      "The Parliament of the Greeks is the first work of monumental scale in the new capital and a representative sample of the early period of neoclassicism in Greece. It was built to be the royal palace, for this reason it is also known as the Old Palace.",
  ...
  },
  {
    ...
    imgurl: [],
    description:
      "It is a two-story tile-roofed building, with a part of a later tile-roofed addition. Morphologically, the building is characterized by a simple neoclassical style. There are shops on the ground floor.",
  ...
  },
  {
    ...
    imgurl: [],
    description:
      "The I. Church of Agia Triada in Peristeri is a rare example of a vaulted single room and small size church. It dates back to the period of the Ottoman Empire.",
...

  {
    ...
    date: "Exact date not available",
    description:
      "It is a one-room domed temple, with a three-sided sanctuary arch. The low dome goes into spherical triangles and covers the main church. Externally it has an octagonal drum. The sanctuary is covered with an arch.",
  ...
  },
  {
    ...
    date: "Exact date not available",
    description:
      "The declared archaeological site includes the source of Kallopoulas located at the foot of Ymittos, as well as the area within a radius of 50 meters.",
    link: "https://www.arxaiologikoktimatologio.gov.gr/el/monuments_info?id=175115&type=Monument",
    colorfill: "#60696B",
  },
  {
  ...
  },
  {
    ...
    date: "Exact date not available",
    description:
      "The natural landscape of Ymittos has been proclaimed thanks to its special natural beauty but also to its special historical importance as it is connected to the centuries-old history and numerous traditions of Attica.",
    link: "https://www.arxaiologikoktimatologio.gov.gr/el/monuments_info?id=165107&type=Space",
    colorfill: "#60696B",
  },
  {
